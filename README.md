...
- Question: We have to put in $1000 of resources into the STEM Mastery Plan. If we want more than $1000 net profit, is it worth to continue offering this plan?
...
- Question: Students are complaining that there are very little Science tutors compared to English. Is this true? Do we have to hire more Science tutors?
...
- Question: In order to market the tutoring center we need to advertise the plan with the most improvement rates and list these percentages. What plans do we include on this marketing campaign?
